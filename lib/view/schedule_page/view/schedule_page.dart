    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
                ...
                Container(
                  ...
                  decoration: ShapeDecoration(
                    ...
                    shape: RoundedRectangleBorder(
                      borderRadius:
                          BorderRadius.circular(AppSize.borderRadiusSm() * 0.4),
                    ),
                  ),
                  child: Padding(
          ...
          Form(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    padding: EdgeInsets.only(
                        top: 0.027 * AppSize.screenHeight,
                  ...
                  SizedBox(
                    height: AppSize.xxl()*1.4,
                    child: SocialAppTextFormField(
          ...
          Padding(
            padding: EdgeInsets.only(
                top: 0.026 * AppSize.screenHeight,
                bottom: 0.01 * AppSize.screenHeight),
            child: Text(
          ...
          Padding(
            ...
            child: Stack(
              children: [
                SizedBox(
                  width: 0.69 * AppSize.screenWidth,
                  height: 0.029 * AppSize.screenHeight,
                ),
                Row(
                  children: [
          ...
          ElevatedButton(
            style: ElevatedButton.styleFrom(
                ...
                shape: RoundedRectangleBorder(
                    borderRadius:
                        BorderRadius.circular(AppSize.borderRadiusLg() * 0.2)),
                minimumSize: Size(
                    0.916 * AppSize.screenWidth, 0.07 * AppSize.screenHeight)),
            child: Center(
              child: Text(
                AppText.scheduleButton,
