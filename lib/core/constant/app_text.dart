class AppText {
  ...
  static String onBoardingTitle = "Welcome to Our Community";
  static String onBoardingSubTitle =
      "Best and popular apps for live education course from home";
  // SingUp Page Texts
  static String facebookLogin = "Log in with Facebook";
  static String googleLogin = "Log in with Google";
  static String login = "Log in";
  static String signUp = "Sign up";
  static String notRegistered = "Don’t have an account?";
  // SignIn Page Texts
  static String signIn = "Log in";
  static String forgotPassword = "Forgot Password?";
  static String registered = "Already have an account?";
  ...
  // Schedule Page Texts
  static String scheduleTitle = "Available time";
  static String scheduleSubTitle = "Adjust to your schedule";
  static String email = "Email";
  static String emailHintText = "samuel_herickson@gmail.com";
  static String telNum = "Telp number";
  static String telNumHintText = "(001) 34 4567890";
  static String scheduleDateAndTime = "Schedule date & time";
  static String dateAndTime = "12 October, 2020 at 09.45 AM";
  static String scheduleButton = "Apply";
